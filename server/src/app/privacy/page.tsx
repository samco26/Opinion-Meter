  ...
  return (
    <main className="page">
      <section className="glass page-card prose">
        ...
        <h2>If you turn on &ldquo;Take the bar with you&rdquo;</h2>
        <p>This is off unless you turn it on in the extension&apos;s settings. With it on, the extension also runs on other websites, where it reads only the page&apos;s address, inside your browser, to show a reading it already holds from Google. It sends nothing about those pages to the server or anywhere else. The readings it carries are kept in the browser only until you close it, and you can turn the whole thing off in the settings at any time.</p>
