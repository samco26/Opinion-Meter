...
- **The page's own rating counts.** A page that rates its subject — IMDb's 8.4/10 from 502K, a shop's 4.2 out of 5, a tomatometer's 94 % — now joins the meter as a block of votes: its value on its own scale read as the share who liked it, weighed by how many rated, up to 500 votes so the words still count. Read from the page's structured data first, else as printed. The card's count line says so ("rated 8.4/10 by 502K on this page") and How it works explains it. Without this, sixty text opinions could call an 8.4 film "52 % positive".
